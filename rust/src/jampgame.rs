...
//! address (behavior-preserving, removes the n=0/n=1 fragility). This module
//! only binds what the ported handlers actually call; the rest of the table
//! arrives with the hook milestones.
...
const FN_Q_STRICMPN: usize = 0x001a_5184;
const FN_INFO_VALUE_FOR_KEY: usize = 0x001a_5604;
const FN_INFO_SET_VALUE_FOR_KEY: usize = 0x001a_5b54;
const FN_CONCAT_ARGS: usize = 0x0012_9c74;
...
mod tests {
    ...
    fn q_stricmp_binding_uses_correct_address() {
        ...
        // (the fn itself is bound when hooks arrive).
        assert_ne!(FN_Q_STRICMPN, 0x001a_5304);
    }
